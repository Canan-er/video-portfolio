    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    'default' => esc_html__('Default', 'swp-portfolio'),
                    'external' => esc_html__('External', 'swp-portfolio'),
                ),
                'default' => 'default'
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .swp-single-inner.style-9 .content-box' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .swp-single-inner.style-9:hover .content-box' => 'background-color: {{VALUE}}',
                ],
            ]
        );
...
plugin::instance()->widgets_manager->register(new Swp_Portfolio_Generel());
